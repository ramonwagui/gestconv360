...
INSERT INTO "new_InstrumentProposal" ("ativo", "concedente", "createdAt", "dataAssinatura", "dataCadastro", "dataDou", "dataPrestacaoContas", "id", "instrumento", "objeto", "observacoes", "orgaoExecutor", "proposta", "responsavel", "status", "updatedAt", "valorContrapartida", "valorRepasse", "vigenciaFim", "vigenciaInicio") SELECT "ativo", "concedente", "createdAt", "dataAssinatura", "dataCadastro", "dataDou", "dataPrestacaoContas", "id", "instrumento", "objeto", "observacoes", "orgaoExecutor", "proposta", "responsavel", "status", "updatedAt", "valorContrapartida", "valorRepasse", "vigenciaFim", "vigenciaInicio" FROM "InstrumentProposal";
